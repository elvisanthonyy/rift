...
route.post('/', passport.authenticate('jwt', { session: false }), async (req, res) => {
...
route.put('/:id', passport.authenticate('jwt', { session: false }), async (req, res) => {
    ...
    try {
        ...
        return res.json({status: 'okay', message: 'post has been edited successfully'})
...
route.get('/friends', passport.authenticate('jwt', { session: false } ), async (req, res) => {
...
route.delete('/delete/:id', passport.authenticate('jwt', { session: false }), async (req, res) => {
